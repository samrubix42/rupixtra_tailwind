<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="space-y-4">
        ...
        <!-- Top bar: search + date filter + export (single row, wraps if needed) -->
      <!-- Top bar -->
        ...
        <div class="w-full sm:w-56">
            ...
            >
                ...
                <div
                    ...
                    class="absolute left-0 z-50 mt-2 w-64 rounded-xl border border-slate-200 bg-white p-4 shadow-lg"
                >
                    <div class="flex items-center justify-between mb-2 text-sm font-medium text-slate-700">
                        <button @click="prev()" class="hover:text-blue-600">‹</button>
                        <div>
                            <span x-text="['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'][month]"></span>
                            <span x-text="year"></span>
                        </div>
                        <button @click="next()" class="hover:text-blue-600">›</button>
                    </div>
    ...
    <div class="flex items-center gap-3">
        ...
        @if($date)
            <button
                ...
                type="button"
                class="h-10 px-3 text-xs font-medium text-rose-600 border border-rose-200 rounded-md hover:bg-rose-50">
                Clear
            </button>
        @endif

        <a
            href="{{ route('admin.contacts.export', ['search' => $search ?: null, 'date' => $date ?: null]) }}"
            target="_blank"
            class="inline-flex items-center justify-center h-10 gap-1 rounded-md border border-slate-300 bg-white px-4
