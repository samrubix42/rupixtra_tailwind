<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="space-y-4">
                ...
                <table class="min-w-full divide-y divide-slate-200 text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100 bg-white">
                        @forelse($users as $user)
                            <tr wire:key="user-{{ $user->id }}" class="hover:bg-slate-50/80">
        ...
        <div class="space-y-3 sm:hidden">
            @forelse($users as $user)
                <div wire:key="user-card-{{ $user->id }}" class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        @include('livewire.admin.user.include.user-modal')
        @include('livewire.admin.user.include.delete')
    </div>
</div>
