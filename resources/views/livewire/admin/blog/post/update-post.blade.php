<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="mb-6 flex items-center justify-between gap-3">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">Update blog post content and SEO data.</p>
        </div>
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-5 space-y-3">
                ...
                ">
                    <textarea
                        x-ref="editor"
                        class="w-full border border-slate-200 rounded-md text-sm">{!! $content !!}</textarea>
                </div>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-5 space-y-3">
                ...
                <div>
                    ...
                    @if ($featured_image)
                    <div class="mt-3">
                        <p class="text-xs text-slate-500 mb-1">New image preview</p>
                    ...
                    <div class="mt-3">
                        ...
                        <img src="{{ asset('storage/'.$post->featured_image) }}" class="h-32 w-full object-cover rounded-md border border-slate-200">
                    </div>
                    @endif
                </div>
            </div>
