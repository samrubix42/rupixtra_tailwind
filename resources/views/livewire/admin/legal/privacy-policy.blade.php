<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="mb-6 flex items-center justify-between gap-3">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">Edit the privacy policy content shown on the website.</p>
        </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-4 sm:p-6 lg:p-8">
        <div class="flex items-center justify-between mb-3">
            <div>
                <h2 class="text-sm font-semibold text-slate-900">Policy Content</h2>
