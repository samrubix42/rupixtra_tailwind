<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="mb-6 flex items-center justify-between gap-3">
        <div>
            <h1 class="text-xl font-semibold text-slate-900">Add Service</h1>
            <p class="mt-1 text-sm text-slate-500">Create a new service with rich content and structured sections.</p>
        </div>
    ...
    <form wire:submit.prevent="save" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <!-- Left: main info + primary section -->
        <div class="lg:col-span-2 space-y-4">
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-5 space-y-4">
                <div>
                    ...
                    <p class="mt-1 text-xs text-slate-500">These details appear in the admin and public URLs.</p>
                </div>
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p class="text-xs text-slate-400">Add optional lending partners for this service (for example banks or NBFCs).</p>
                    </div>
                ...
                <div class="space-y-4">
                                ...
                                <div class="flex-1 space-y-3">
                                    ...
                                    <div>
                                        ...
                                        @if (!empty($lender['logo']))
                                            <div class="mt-2">
                                                <p class="text-[11px] text-slate-500 mb-1">Logo preview</p>
                    ...
                    @empty
                        <p class="text-sm text-slate-500">No lenders added yet. Click "Add Lender" to link a finance partner.</p>
                    @endforelse
                </div>
            </div>
        </div>
        ...
        <div class="space-y-4">
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-5 space-y-3">
                ...
                <p class="text-xs text-slate-400">Optional thumbnail shown on service pages.</p>
