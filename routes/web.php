...
use App\Livewire\Public\Privacy\Disclaimer as PublicDisclaimer;
...
use App\Livewire\Admin\Legal\Disclaimer as AdminDisclaimer;
...
Route::livewire('disclaimer', PublicDisclaimer::class)->name('disclaimer');
...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    Route::livewire('legal/disclaimer', AdminDisclaimer::class)->name('admin.legal.disclaimer');
});
